...
import { LayoutDashboard, Users, Activity, Settings, Server, Workflow, Sun, Moon, Languages, Globe, BookOpen, FileCode2, BarChart3, MessageSquare } from 'lucide-react'
...
const navDefs: NavDef[] = [
  ...
  { to: '/analytics', labelKey: 'nav.analytics', icon: <BarChart3 className="size-[18px]" /> },
  { to: '/dialogs', labelKey: 'nav.dialogs', icon: <MessageSquare className="size-[18px]" /> },
