...
func main() {
	...
	if err == nil && settings == nil {
		...
		settings = &database.SystemSettings{MaxConcurrency: 2, GlobalRPM: 0, TestModel: "gpt-5.4", TestConcurrency: 50, PgMaxConns: 50, RedisPoolSize: 30, FastSchedulerEnabled: true}
	} else {
