...
func (db *DB) migrateSQLite(ctx context.Context) error {
	statements := []string{
		...
		`CREATE TABLE IF NOT EXISTS system_settings (
			...
			fast_alias_enabled INTEGER DEFAULT 1,
	...
	columns := []struct {
		...
		{"system_settings", "fast_alias_enabled", "INTEGER DEFAULT 1"},
		...
		{"system_settings", "model_payload_overrides", "TEXT DEFAULT '{}'"},
		{"system_settings", "resin_url", "TEXT DEFAULT ''"},
		{"system_settings", "resin_platform_name", "TEXT DEFAULT ''"},
		{"system_settings", "rt_manager_url", "TEXT DEFAULT ''"},
		{"system_settings", "rt_manager_password", "TEXT DEFAULT ''"},
